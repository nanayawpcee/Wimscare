...
// --- Static frontend ---
// On Vercel this is dead code in production (the public/ directory is served
// natively by Vercel's static hosting, see vercel.json) but it's what makes
// `node server.js` and Render work.
